...
class BluetoothA2DPSink : public BluetoothA2DPCommon {
 ...
 public:
  ...
  /// Defines the method which will be called with the codec configuration is updated
 ...
 protected:
  ...
  void (*codec_config_callback)(uint32_t rate, uint8_t bps, uint8_t channels, const char* codec_name) = nullptr; // 定义codec配置回调
